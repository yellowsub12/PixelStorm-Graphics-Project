...
GLuint bus1frontTexture = 0;
GLuint bus1backTexture = 0;
GLuint bus1bottomTexture = 0;
GLuint bus1topTexture = 0;
GLuint bus1leftTexture = 0;
GLuint bus1rightTexture = 0;
GLuint bus2frontTexture = 0;
GLuint bus2backTexture = 0;
GLuint bus2bottomTexture = 0;
GLuint bus2topTexture = 0;
GLuint bus2leftTexture = 0;
GLuint bus2rightTexture = 0;
GLuint wheelTexture = 0;
GLuint rimTexture = 0;
GLuint antennaTexture = 0;
GLuint antenna2Texture = 0;
int randomHumanFactor = 1.4; // The random factor which affects the scale of the building.// = rand() % 11; 
...
void Initialize()
{
	...
	bus1frontTexture = loadTexture((texturesPathPrefix + "busfront1.png").c_str());
	bus1backTexture = loadTexture((texturesPathPrefix + "busback1.png").c_str());
	bus1topTexture = loadTexture((texturesPathPrefix + "bustop1.png").c_str());
	bus1bottomTexture = loadTexture((texturesPathPrefix + "busbottom1.jpg").c_str());
	bus1leftTexture = loadTexture((texturesPathPrefix + "busleft1.png").c_str());
	bus1rightTexture = loadTexture((texturesPathPrefix + "busright1.png").c_str());
	bus2frontTexture = loadTexture((texturesPathPrefix + "busfront2.png").c_str());
	bus2backTexture = loadTexture((texturesPathPrefix + "busback2.png").c_str());
	bus2topTexture = loadTexture((texturesPathPrefix + "bustop2.png").c_str());
	bus2bottomTexture = loadTexture((texturesPathPrefix + "busbottom2.jpg").c_str());
	bus2leftTexture = loadTexture((texturesPathPrefix + "busleft2.png").c_str());
	bus2rightTexture = loadTexture((texturesPathPrefix + "busright2.png").c_str());
...
{
	int probabilityCheck = rand() % 100; // Variable to help us adjust what numbers spawn more often and what numbers spawn less often. 
	int randomTrashFactor = 1.0; // The random factor which affects the scale of the building.// = rand() % 11; 
	if (probabilityCheck < 2) randomTrashFactor = 1.6; // less than 2% of buildings will be 15 units tall
	if (probabilityCheck >= 2 && probabilityCheck < 30) randomTrashFactor = 1.4; // around 28% of the city will be buildings that are between 3 to 5 units tall
	if (probabilityCheck >= 30 && probabilityCheck < 50) randomTrashFactor = 1.2; // around 20% of the city will be buildings that are between 4 to 6 units tall
	if (probabilityCheck >= 50) randomTrashFactor = 1.0; // Lastly, the remaining 50% of buildings will be about 1 to 2 units tall. 
	...
	mat4 trashWorldMatrix = translate(mat4(1.0f), vec3(position.x, (position.y+(1.25/2)) * randomTrashFactor , position.z))
		* scale(mat4(1.0f), vec3(1.1, 1.5 * randomTrashFactor, 1.1)); //(0.5*(1+randomFactor))+scaleOffset
	...
	mat4 trashBinWorldMatrix = translate(mat4(1.0f), vec3(position.x, (position.y + 0.75) * randomTrashFactor, position.z))
		* scale(mat4(1.0f), vec3(1.0, 1.5 * randomTrashFactor, 1.0)); //(0.5*(1+randomFactor))+scaleOffset
...
{
	//int probabilityCheck = rand() % 100; // Variable to help us adjust what numbers spawn more often and what numbers spawn less often. 
	//if (probabilityCheck < 2) randomHumanFactor = 1.5; // less than 2% of buildings will be 15 units tall
	//if (probabilityCheck >= 2 && probabilityCheck < 30) randomHumanFactor = 1.6; // around 28% of the city will be buildings that are between 3 to 5 units tall
	//if (probabilityCheck >= 30 && probabilityCheck < 50) randomHumanFactor = 1.8 ; // around 20% of the city will be buildings that are between 4 to 6 units tall
	//if (probabilityCheck >= 50) randomHumanFactor = 1; // Lastly, the remaining 50% of buildings will be about 1 to 2 units tall. 
...
void DrawBus(vec3 position, float tileSize, GLuint worldMatrixLocation, GLuint textureLocation)
{
	...
	if (random_integer == 2) {
		// Front
		glBindTexture(GL_TEXTURE_2D, bus1frontTexture);
		glUniform1i(textureLocation, 1);
		...
		// Back 
		glBindTexture(GL_TEXTURE_2D, bus1backTexture);
		glUniform1i(textureLocation, 1);
		...
		// Top
		glBindTexture(GL_TEXTURE_2D, bus1topTexture);
		glUniform1i(textureLocation, 1);
		...
		// Bottom
		glBindTexture(GL_TEXTURE_2D, bus1bottomTexture);
		glUniform1i(textureLocation, 1);
		...
		// Left
		glBindTexture(GL_TEXTURE_2D, bus1leftTexture);
		glUniform1i(textureLocation, 1);
		...
		// Right
		glBindTexture(GL_TEXTURE_2D, bus1rightTexture);
		glUniform1i(textureLocation, 1);
	...
	if (random_integer == 3) {
		// Front
		glBindTexture(GL_TEXTURE_2D, bus2frontTexture);
		glUniform1i(textureLocation, 1);
		...
		// Back 
		glBindTexture(GL_TEXTURE_2D, bus2backTexture);
		glUniform1i(textureLocation, 1);
		...
		// Top
		glBindTexture(GL_TEXTURE_2D, bus2topTexture);
		glUniform1i(textureLocation, 1);
		...
		// Bottom
		glBindTexture(GL_TEXTURE_2D, bus2bottomTexture);
		glUniform1i(textureLocation, 1);
		...
		// Left
		glBindTexture(GL_TEXTURE_2D, bus2leftTexture);
		glUniform1i(textureLocation, 1);
		...
		// Right
		glBindTexture(GL_TEXTURE_2D, bus2rightTexture);
		glUniform1i(textureLocation, 1);
